...
class LinkedList {
    ...
    void addFirst (Object data){
        src.DataStructure.DoublyLinkedList.Node input = new src.DataStructure.DoublyLinkedList.Node(data);
        if (isEmpty()){
            head = tail = input;
        }else {
            input.next = head;
    ...
    void insertBefore (Object target, Object data){
        src.DataStructure.DoublyLinkedList.Node input = new src.DataStructure.DoublyLinkedList.Node(data);
        src.DataStructure.DoublyLinkedList.Node p = head;
        while (p != null){
...
//    }
    ...
    void replace (int index, Object data){
        src.DataStructure.DoublyLinkedList.Node p = head;
        src.DataStructure.DoublyLinkedList.Node input = new Node(data);
